...
# 20220414
urls = [f"""https://api.bilibili.com/x/v3/fav/resource/list?media_id=82633499&pn={str(n)}&ps=20&keyword=&order=mtime&type=0&tid=0&platform=web&jsonp=jsonp""" for n in range(1, 4)]
